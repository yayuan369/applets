<template>
  ...
  <div @click="clickHandle('test click', $event)">
    <div>
      <wux-floating-button v-bind:buttons="buttons" @iclick="handleClick6"></wux-floating-button>
    </div>
    <div>
      <wu-input-number></wu-input-number>
    </div>
    <div>
      <wux-vcode bg-color="#e6f6ff" font-color="#165189"></wux-vcode>
    </div>
    ...
    <a href="/pages/auth/login" class="counter">去往登录页面</a>
  </div>
</template>
